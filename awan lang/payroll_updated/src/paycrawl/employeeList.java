...
public class employeeList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        employeeList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {11111, "Nick L. Back", "Manager"},
                {11112, "Ami I. Li", "Admin"},
                {11113, "April L. Abin", "Admin"},
                {11113, "Chester P. Ark", "Production Supervisor"},
                {11114, "Linkin B. Ennington", "Production Operator"},
                {11115, "Tris D. Orsdown", "Production Operator"},
                {12345, "Rock N. Roll", "Maintenance"},
                {12367, "Slip K. Not", "Maintenance"},
                {14567, "Ace D. Green", "Admin"},
                {11127, "Eva N. Essence", "Production Supervisor"},
                {11128, "Travis T. Ritt", "Admin"},
                {18967, "Alan J. Ackson", "Admin"},
                {19067, "Keith R. Van", "Production Operator"},
                {19876, "Josh T. Kner", "Production Operator"},
                {null, null, null},
                {null, null, null},
                {null, null, null},
                {null, null, null},
